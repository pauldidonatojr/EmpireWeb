...
function BatchDetails() {
  ...
  const columns3 = [
    ...
    { field: "VisitFrom", headerName: "Visit From", width: 150 },
    { field: "VisitTo", headerName: "Visit To", width: 100 },
  ...
  const rows3 = [
    {
      id: 1,
      InvoiceNumber: "Justin",
      BatchNumber: "Alo",
      VisitFrom: "02457894561",
      VisitTo: "XOXO",
      AdmissionID: "XZXZ",
      MemberName: "1123456",
      Address: "Justin",
      TotalHours: "Alo",
      TotalAmount: "02457894561",
      MCO: "XOXO",
    ...
    return (
      <div style={{overflow:"auto",width:"100%",height:"100%"}}>
        ...
        <h2 className="infodisplay2">
           Batch Number: <span style={{ color: "#564873" }}>110245</span>
          </h2>
          <h2 className="infodisplay2">
           Batch Date :{" "}
          ...
          <div className="datafieldHolder">
        <h2 className="infodisplay2">
           Invioce Count: <span style={{ color: "#564873" }}>11</span>
          </h2>
          <h2 className="infodisplay2">
           Total Amount :{" "}
          ...
          <div className="datafieldHolder">
        <h2 className="infodisplay2">
           Total OT Hours: <span style={{ color: "#564873" }}>11</span>
          </h2>
          <h2 className="infodisplay2">
           Total TT Hours :{" "}
          ...
          <div className="datafieldHolder">
        <h2 className="infodisplay2">
           Provider: <span style={{ color: "#564873" }}>Empire HomeCare</span>
          </h2>
          <h2 className="infodisplay2">
           Status :{" "}
