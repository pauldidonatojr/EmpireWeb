...
import { editCareGiver } from "../API/careGiverAPI";

function CareGiverDetailSFTP() {
      ...
      for (var key in visitData) {
        if (visitData[key].CaregiverFirstName + " " + visitData[key].CaregiverLastName == selectedMemberName) {
          ...
          var obj = {
            ...
            Schedule: dayjs(myArray.ScheduleStartTime).format('YYYY-MM-DD') + " TO " + dayjs(myArray.ScheduleEndTime).format('YYYY-MM-DD'),
            Visit: dayjs(myArray.VisitStartTime).format('YYYY-MM-DD') + " TO " + dayjs(myArray.VisitEndTime).format('YYYY-MM-DD'),
                    ...
                    {caregiver != null &&
                      <div style={{ margin: "5px" }}>
                        <TextField
                          ...
                          onChange={(evt) => { setAddressStreet1(evt.target.value) }}
                        />
                      </div>
                    }
                  </Grid>
                    ...
                    {caregiver != null &&
                      <div style={{ margin: "5px" }}>
                        <TextField
                          ...
                          onChange={(evt) => { setAddressStreet2(evt.target.value) }}
                    ...
                    {caregiver != null &&
                      <div style={{ margin: "5px" }}>
                        <TextField
                          ...
                          variant="outlined"
                          value={addressCity}
                          onChange={(evt) => { setAddressCity(evt.target.value) }}
                    ...
                    {caregiver != null &&
                      <div style={{ margin: "5px" }}>
                        <TextField
                          ...
                          variant="outlined"
                          value={addressZip}
                          onChange={(evt) => { setAddressZip(evt.target.value) }}
                    ...
                    {caregiver != null &&
                      <div style={{ margin: "5px" }}>
                        <TextField
                          ...
                          variant="outlined"
                          value={addressPhone}
                          onChange={(evt) => { setAddressPhone(evt.target.value) }}
                    ...
                    {caregiver != null &&
                      <div style={{ margin: "5px" }}>
                        <TextField
                          ...
                          variant="outlined"
                          value={addressPhone2}
                          onChange={(evt) => { setAddressPhone2(evt.target.value) }}
                    ...
                    {caregiver != null &&
                      <div style={{ margin: "5px" }}>
                        <TextField
                          ...
                          onChange={(evt) => { setAddressHomePhone(evt.target.value) }}
...
export default CareGiverDetailSFTP;
